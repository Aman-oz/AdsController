...
class FacebookNativeBanner(private val activity: Activity) {

    private val TAG = FacebookNativeBanner::class.java.simpleName
    fun loadNativeBannerAds(
        ...
        val nativeAdListener = object : NativeAdListener {
            ...
            override fun onAdLoaded(ad: Ad?) {
                if (isCustomLayout){
                    customNativeBannerLayout(customAdLayout,nativeBannerAd, nativeAdLayout)
                }else {
    ...
    private fun customNativeBannerLayout(customAdLayout: Int,nativeBannerAd: NativeBannerAd, nativeAdLayout: NativeAdLayout) {
